{
    let view = {
        el: '.uploadArea',
        template: `
            <div id="container" class="dragArea">
                <div id="pickfiles" class="clickArea">
                    <p>点击或拖曳上传</p>
                    <p>文件大小不能超过40MB</p>
                </div>
            </div>
    ...
    let controller = {
        ...
        initQiniu(){
            var uploader = Qiniu.uploader({
                ...
                domain: 'http://paqz7p436.bkt.clouddn.com/',     // bucket 域名，下载资源时用到，如：'http://xxx.bkt.clouddn.com/' **必需**
                ...
                init: {
                    ...
                    'FileUploaded': function (up, file, info) {
                        ...
                        uploadStatus.textContent = '链接：' + sourceLink + '文件名：' + response.key
                    },
